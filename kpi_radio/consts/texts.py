...
ORDER_ACCEPTED_TOOLATE = 'Ми хотіли прийняти ваше замовлення "<b>{0}</b>", ({1}), але воно вже не влізе в етер(( ' \
...
ORDER_PEREZAKLAD = 'Ваше замовлення не встигло заграти на цьому етері. Бажаєш перезамовлення?'
