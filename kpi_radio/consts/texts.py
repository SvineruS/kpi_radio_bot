...
ORDER_CHOOSE_SONG = 'Что ты хочешь услышать?\n' \
                    '➖ Напиши название песни и бот ее найдет 🔎\n' \
                    '➖ Скинь ссылку на трек с music.youtube.com\n' \
                    '➖ Загрузи или перешли аудиофайл\n' \
                    '➖ Воспользуйся инлайн поиском ниже\n' \
                    '➖ Используй других ботов для поиска и перешли аудио сюда (@vkm4bot, @LyBot)\n' \
                    '\n⛔️/cancel для отмены'

ORDER_INLINE_SEARCH = 'Нажми на кнопку для инлайн-поиска в нашем боте 👀'

CHOOSE_DAY = 'Выбери день'
CHOOSE_TIME = '{0}, отлично. Теперь выбери время'
