...
ORDER_PEREZAKLAD = 'Ваше замовлення не встигло заграти на цьому ефірі. Бажаєш перезамовлення?'
ORDER_ERR_TOOLATE = 'На цей час вже точно не встигне'
ORDER_ERR_TOOMUCH = 'Ви замовили забагато треків на цей ефір'

HISTORY_TITLE = 'Замовив/-а {0}'
...
⚠️ Будь ласка, не замовляй багато пісень одразу. Не замовляй більше 1 треку на ефір, окрім вечірнього.
...
- Замовлення <b>одноразове</b>. Якщо твоя пісня не встигла увійти в ефір, <b>перезамов наступного разу</b>.''',
