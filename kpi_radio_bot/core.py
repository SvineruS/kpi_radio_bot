...
async def order_time_choiced(query, day: int, time: int):
 ...
 Сейчас нам нужна помощь с проектом <b>Патио</b>. Пройди по ссылке ниже и отдай свой голос за проекты <b>2147</b> и <b>2149</b> "Патио", чтобы на КПИ появился новый удобный коворкинг!
 <i>нам нужно около 2000 голосов и помощь с распространением информации не помешает 🙃</i>
 
 https://telegra.ph/Kak-progolosovat-za-KPIshnye-proekty-v-GB4-05-15
     """)
